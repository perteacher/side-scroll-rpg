...
const SIGNATURE_DATA = {
  ...
  scout: { traitId: 'swift', skill: { id: 'sig_scout', name: '속사 난무', kind: 'barrage', dmgMult: 0.85, hits: 5, manaCost: 26, cooldownMs: 10000 } },
  ...
  vernelia: { traitId: 'tactician', skill: { id: 'sig_vernelia', name: '서리 결계', kind: 'buff', manaCost: 30, cooldownMs: 20000, durationMs: 12000, buff: { defPct: 0.18, crit: 8 }, element: 'ice' } },
  ...
  // --- 4티어 영입 ---
  catrenne: { traitId: 'arcane', skill: { id: 'sig_catrenne', name: '절대 영도', kind: 'aoe', dmgMult: 2.5, aoeRadius: 180, manaCost: 36, cooldownMs: 12000, element: 'ice' } },
